...
class Ux21AssetsTest(unittest.TestCase):
    def test_public_versions_are_updated_without_breaking_legacy_support(self):
        ...
        self.assertEqual(main.PWA_VERSION, "1.1.0")
    ...
    def test_pwa_ux_11_assets_are_installable_and_cached(self):
        ...
        self.assertIn("PWA 1.1.0", index)
        self.assertIn("/pwa-assets/ux.js?v=20260830-1", index)
        self.assertIn("rpo-pwa-shell-v1.1.0", sw)
