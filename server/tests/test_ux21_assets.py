...
class Ux21AssetsTest(unittest.TestCase):
    def test_public_versions_are_updated_without_breaking_legacy_support(self):
        ...
        self.assertEqual(main.PWA_VERSION, "1.1.2")
    ...
    def test_pwa_ux_112_assets_are_installable_cached_and_server_confirmed(self):
