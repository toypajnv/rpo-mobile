const CACHE='rpo-pwa-shell-v1.0.1';
const SHELL=['/app/','/app/manifest.webmanifest','/app/icon-180.png','/app/icon-192.png','/app/icon-512.png','/pwa-assets/app.css?v=20260829-2','/pwa-assets/app.js?v=20260829-2'];
