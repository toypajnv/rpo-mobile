const CACHE='rpo-pwa-shell-v1.1.1';
const SHELL=['/app/','/app/manifest.webmanifest','/app/icon-180.png','/app/icon-192.png','/app/icon-512.png','/pwa-assets/app.css?v=20260829-2','/pwa-assets/ux.css?v=20260830-1','/pwa-assets/app.js?v=20260829-2','/pwa-assets/ux.js?v=20260830-2'];
